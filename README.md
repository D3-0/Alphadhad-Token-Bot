...
Alphadhad X Connect Bot is a specialized bot that utilizes NFT tokens and/or Jettons to manage access to your
private
...
| `EXCLUDE_WALLETS`                         | `list` | List of wallets to exclude                                                                                                                                
